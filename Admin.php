  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link"  href="Items.php?page=add" method="GET">Add Items</a>
        </li>
        <li class="nav-item">
          <a class="nav-link"  href="Items.php?page=delete" method="GET">Remove Items</a>
        </li>
        <li class="nav-item">
          <a class="nav-link"  href="Items.php?page=modify">Modify Items</a>
        </li>
        <li class="nav-item">
